...
export class SatelliteService {
    ...
    create(newSatellite: ISatellite) {
        const satellite = {
            ...newSatellite,
    ...
    update(updatedSatellite: ISatellite) {
        updatedSatellite.updatedAt = new Date();
    ...
    // getById(id: number): ISatellite | undefined {
    // return satellites.find((satellite) => satellite.id === id);
    // }

    // getSatellitesOfUserWithId(id: number): ISatellite[] {
